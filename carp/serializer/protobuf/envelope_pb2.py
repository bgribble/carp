...
_ENVELOPE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='content_type', full_name='carp.Envelope.content_type', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='content', full_name='carp.Envelope.content', index=1,
...
Envelope = _reflection.GeneratedProtocolMessageType('Envelope', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:carp.Envelope)
  })
